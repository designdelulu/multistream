...
export function bindStreamReorder(
  ...
  const gridSortable = Sortable.create(grid, {
    ...
    filter:
      '.stream-card__theater, .stream-card__focus, .stream-card__reload, .stream-card__close, .stream-card__overlay-theater, .stream-card__overlay-focus, .stream-card__overlay-reload, .stream-card__overlay-remove, a, input, select, textarea',
