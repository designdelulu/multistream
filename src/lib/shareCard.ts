...
/** Meta Stories ~14% top overlay (1080×1920 → 269px). Branding sits below it. */
export const STORY_SAFE_TOP = Math.round(SHARE_CARD_HEIGHT * 0.14);
export const STORY_BRAND_BASELINE_Y = 320;
export const STORY_TAGLINE_BASELINE_Y = 354;
export const STORY_PILL_Y = 400;
export const STORY_HEADLINE_BASELINE_Y = 528;
export const STORY_COUNT_BASELINE_Y = 578;
